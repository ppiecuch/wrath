...
GL_RAW_HEADER_FILES=OpenGL/gl.h OpenGL/gl3.h OpenGL/glext.h
GL_RAW_HEADER_FILENAMES=$(subst OpenGL/,,$(GL_RAW_HEADER_FILES))
GL_HEADER_FILES=$(GL_RAW_HEADER_FILENAMES:%.h=$(GL_INCLUDEPATH)/%.h)
else
